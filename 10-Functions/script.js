...
// /* L'appel de g() va créer la variable "a" et ré-assigner "f" à une fonction puis la VE disparaît.
// Une Closure existe alors f() garde dans son sac à dos la VE de la fonction g(). */
// g();
// f(); // 40
// console.dir(f); // cf. Console

// /* L'appel de h() va créer la variable "b" et ré-assigner "f" à une nouvelle fonction puis la VE disparaît.
// Une  nouvelle Closure existe alors et f() a lâché son ancien sac à dos pour un nouveau : celui de la VE dans
// laquelle il vient d'être ré-assigné. */
// h();
// f(); // 500
// console.dir(f); // cf. Console
...
// /* Lors de l'appel de cette fonction : la variable perGroup est crée, puis la callback function setTimeout est call mais elle prendra
// plusieurs secondes à se lancer, pendant ce temps le dernier console.log est retourné et la fonction disparaît de la Call Stack mais
// la fonction setTimeout a fini d'écouler son temps et s'exécute alors. Elle peut accéder à la Variable Environment qui est sorti de la
// Call Stack car une Closure est crée (elle avait un sac à dos avec tout le Variable Environment dans lequel elle née) */
...
// /* La Closure a la priorité sur tout le reste, ici elle prendra en compte le "perGroup" qui est dans la Closure plutôt que celle qui
// est dans la Global Scope (ci-dessous) */
// const perGroup = 1000;
// boardPassengers(180, 3);
